...
export const swaggerPaths: OpenAPIV3.PathsObject = {
  ...
  '/users': {
    post: {
      ...
      description: 'Cria um novo usuário no sistema. O tipo de usuário (PLAYER/MASTER) é determinado pelo campo masterConfirm. Se masterConfirm=true, o campo enrollment torna-se obrigatório.',
      requestBody: {
        required: true,
        content: {
          'application/json': {
      ...
      responses: {
        ...
        '400': {
          description: 'Dados inválidos ou matrícula obrigatória para mestres não informada',
          content: {
            'application/json': {
              schema: {
  ...
  '/my-enrolled-sessions': {
    get: {
      ...
      description: 'Retorna todas as sessões nas quais o usuário logado está inscrito',
      security: [
        {
          bearerAuth: []
        }
  ...
  '/sessions/approved': {
    get: {
      ...
      description: 'Retorna todas as sessões aprovadas e disponíveis para inscrição',
      responses: {
        '200': {
  ...
  '/sessions': {
    get: {
      ...
      description: 'Retorna todas as sessões do sistema (apenas para administradores)',
      security: [
        {
          bearerAuth: []
        }
    ...
    post: {
      ...
      description: 'Cria uma nova sessão RPG com múltiplas datas possíveis. Apenas mestres podem criar sessões. A sessão criada fica com status PENDENTE até aprovação de um administrador.',
      security: [
        {
          bearerAuth: []
        }
        ...
        content: {
          'application/json': {
            ...
            example: {
              ...
              description: 'Uma aventura gótica de horror em Barovia, onde os heróis devem enfrentar o vampiro Conde Strahd von Zarovich.',
              requirements: 'Conhecimento básico de D&D 5e, disponibilidade para sessões semanais',
              system: 'D&D 5e',
              possibleDates: [
