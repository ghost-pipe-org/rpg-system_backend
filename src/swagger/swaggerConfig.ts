      ...
      RegisterRequest: {
        ...
        properties: {
          ...
          enrollment: {
            ...
            maxLength: 9,
            example: '123456789',
            description: 'Matrícula obrigatória apenas para mestres (masterConfirm=true)'
          },
          phoneNumber: {
            type: 'string',
            maxLength: 20,
          ...
          masterConfirm: {
            type: 'boolean',
            example: false,
            description: 'Define se o usuário será MASTER (true) ou PLAYER (false)'
          }
        }
      },
      CreateSessionRequest: {
        type: 'object',
        required: ['title', 'description', 'system', 'possibleDates', 'period', 'minPlayers', 'maxPlayers', 'location'],
        properties: {
          title: {
            type: 'string',
            maxLength: 255,
