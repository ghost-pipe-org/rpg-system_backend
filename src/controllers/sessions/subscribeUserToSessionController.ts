...
export async function subscribeUserToSessionController(req: Request, res: Response) {
    ...
    try {
        ...
        return res.status(200).json({ message: 'User subscribed to session successfully' });
